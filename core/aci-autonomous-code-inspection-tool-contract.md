...
`ACI` is the common autonomous code-inspection tool body. It interprets the `CI-01` to `CI-27` catalog, runs native / external / human-judgment lanes, normalizes evidence, and returns ranked findings.
...
- `aci-code-inspection-execution-spec.md`: compact `CI-01` to `CI-27` catalog and report contract
...
- select inspection lanes for `CI-01` to `CI-27`
