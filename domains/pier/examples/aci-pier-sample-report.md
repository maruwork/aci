...
- `R-001`
  ...
  - reason:
    - domain rules module mixes vocabulary config and domain registration; splitting would improve single-responsibility but requires a coordinated pier pack update
  - next wave:
    - `pier pack responsibility boundary review`
