...
**依存タスク**: なし  
**参照設計書**:
- [SE-251_autonomous-code-inspection-tool.md](/C:/Users/f_tan/project/pier/shared/docs/design/SE-251_autonomous-code-inspection-tool.md)
- [task_aci001_trigger-routing-spec.md](/C:/Users/f_tan/project/pier/shared/specs/current/task_aci001_trigger-routing-spec.md)
- [task_aci001_trigger-read-spec.md](/C:/Users/f_tan/project/pier/shared/specs/current/task_aci001_trigger-read-spec.md)
- [autonomous-code-inspection-tool_design_20260522.md](/C:/Users/f_tan/project/pier/workspace/claudecode-output/governance/autonomous-code-inspection-tool_design_20260522.md)
...
> generic `ACI` の正本棚は repo root、template 正本棚は `templates/`。
...
ACI の共通契約は [SE-251_autonomous-code-inspection-tool.md](/C:/Users/f_tan/project/pier/shared/docs/design/SE-251_autonomous-code-inspection-tool.md) を正とする。  
`Pier` での trigger / surface / storage / completion authority は本 spec を正とする。

ただし、

- trigger routing は [task_aci001_trigger-routing-spec.md](/C:/Users/f_tan/project/pier/shared/specs/current/task_aci001_trigger-routing-spec.md)
- trigger ごとの read-budget / read-surface は [task_aci001_trigger-read-spec.md](/C:/Users/f_tan/project/pier/shared/specs/current/task_aci001_trigger-read-spec.md)
...
- [task_aci001_validation-decision-register.md](/C:/Users/f_tan/project/pier/shared/specs/current/task_aci001_validation-decision-register.md)
