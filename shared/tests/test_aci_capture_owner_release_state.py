...
def test_release_blockers_include_pypi_conflict_and_missing_release() -> None:
    snapshot = {
        "project": {"distribution_name": "ac-inspector", "version": "0.1.2"},
    ...
    assert "PyPI package name 'ac-inspector' exists but latest version is '1.3', not the local release version '0.1.2'." in blockers
...
def test_release_blockers_treat_matching_pypi_version_as_release_evidence() -> None:
    snapshot = {
        "project": {"distribution_name": "ac-inspector", "version": "0.1.2"},
        "pypi": {"exists": True, "latest_version": "0.1.2"},
        "github": {
