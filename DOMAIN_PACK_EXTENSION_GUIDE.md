...
2. define one `<DOMAIN>_DOMAIN_RULES` object matching `python/aci_domain_contract.py`
3. keep absolute paths, trigger schedules, and output locations out of the domain pack
4. add a bounded loader branch in `python/aci_domain_loader.py`
...
- generic signal semantics stay in `python/aci_signals.py`
